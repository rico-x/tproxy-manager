...
`![Статус TPROXY](docs/screenshots/01-tproxy-full.png)`
...
`![Порты TPROXY](docs/screenshots/02-ports-split.png)`
...
`![Режимы портов и источников](docs/screenshots/03-modes.png)`
...
`![Редактор списков](docs/screenshots/04-unified-editor.png)`
...
`![DHCP аренды — быстрое добавление](docs/screenshots/05-dhcp-quick-add.png)`
...
`![Дополнительные настройки](docs/screenshots/06-advanced.png)`
...
`![Статус Xray](docs/screenshots/07-xray-status.png)`
...
`![Лог системы](docs/screenshots/08-logread.png)`
...
`![Проверка конфигурации Xray](docs/screenshots/09-xray-test.png)`
...
`![Список источников GEO](docs/screenshots/10-geo-list.png)`
...
`![Глобальное редактирование GEO JSON](docs/screenshots/11-geo-json.png)`
