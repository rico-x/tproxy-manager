...
Блок расшифровывает Happ deep-links прямо в браузере:
...
Для `crypt5` пакет содержит локальный файл ключей, поэтому внешняя сеть и дополнительные npm/Node-зависимости на роутере не нужны.
