...
(function(){
  ...
  // Name the file in the delete confirmation: the other buttons redirect and the
  // selector returns on the first file, so a bare "Delete selected file?" can be
  // confirmed for a file the user never had open.
  document.addEventListener('DOMContentLoaded', function(){
    var del = document.querySelector('#singbox-editor button[name="_singbox_delete"]');
    if (!del) return;
