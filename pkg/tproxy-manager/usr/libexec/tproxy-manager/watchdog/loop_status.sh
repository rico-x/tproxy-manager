...
HYSTERIA_TEMPLATE_FILE=$HYSTERIA_TEMPLATE_FILE
HYSTERIA_TEST_TEMPLATE_FILE=$HYSTERIA_TEST_TEMPLATE_FILE
HYSTERIA_BATCH_TEST_TEMPLATE_FILE=$HYSTERIA_BATCH_TEST_TEMPLATE_FILE
